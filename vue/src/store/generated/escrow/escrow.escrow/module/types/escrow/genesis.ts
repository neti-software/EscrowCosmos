...
export const GenesisState = {
  encode(message: GenesisState, writer: Writer = Writer.create()): Writer {
    ...
    for (const v of message.storedEscrowList) {
      StoredEscrow.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      object.storedEscrowList !== undefined &&
      object.storedEscrowList !== null
    ) {
      for (const e of object.storedEscrowList) {
        message.storedEscrowList.push(StoredEscrow.fromJSON(e));
      }
    }
    return message;
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.systemInfo !== undefined &&
      (obj.systemInfo = message.systemInfo
        ...
        : undefined);
    if (message.storedEscrowList) {
      obj.storedEscrowList = message.storedEscrowList.map((e) =>
        e ? StoredEscrow.toJSON(e) : undefined
      );
    } else {
      obj.storedEscrowList = [];
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GenesisState>): GenesisState {
    ...
    if (
      ...
      for (const e of object.storedEscrowList) {
        message.storedEscrowList.push(StoredEscrow.fromPartial(e));
      }
    }
    return message;
  },
